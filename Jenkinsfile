    ...
    stages {
        stage('Get Code') {
            steps {
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/feature_fix_racecond']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/leyrecanales10/helloword.git']]])
            }
        }
